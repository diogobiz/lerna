...
import { useWindowSize } from "@diogobiz/utils/dist/Hooks";
...
const ProfileTab = ({
  ...
  const ingressPeriod = () => {
    if (
      ...
      const year =
        savedYear.length > 4 ? format(new Date(savedYear), "YYYY") : savedYear;
              ...
              <SANForm form={form} onSubmit={handleSubmit}>
                <SANBox px={{ sm: "9", _: 0 }}>
                  ...
                  <SANFormItem
                    ...
                    initialValue={user.phone_number || undefined}
                  >
                    <SANInputMask
                      data-testid="flix_profile_tab-personal--input-cellphone"
                      mask="PHONE"
                      InputProps={{
                        placeholder: t("profile.tab1.phone"),
                        size: "large"
                      }}
                    />
                  </SANFormItem>
                  {universities.length > 0 && (
                    <SANFormItem
                      name="university"
                      label={t("profile.tab1.university.label")}
                      mb="md"
                    ...
                    >
                      <SANSelect
                        ...
                        placeholder={t("profile.tab1.university.placeholder")}
                        size="large"
                      >
                  ...
                  <SANFormItem
                    name="methodology"
                    label={t("profile.tab1.methodology.label")}
                    mb="md"
                    initialValue={
                      user.userMedUniversity &&
                  ...
                  >
                    <SANSelect
                      ...
                      placeholder={t("profile.tab1.methodology.placeholder")}
                      size="large"
                  ...
                  {otherMethodology ? (
                    <SANFormItem name="newMethodology" mb="md">
                      <SANInput
                        size="large"
                        placeholder={t(
                ...
                <SANBox px={{ sm: "9", _: 0 }}>
                  ...
                  >
                    <SANInputMask
                      ...
                      mask="POSTAL_CODE"
                      InputProps={{
                        placeholder: t("profile.tab2.postalCode"),
                        size: "large"
                      }}
                    />
                  </SANFormItem>
                  <SANFormItem
                    ...
                    initialValue={
                      !!user.address ? user.address.address : undefined
                    }
                  >
                    <SANInput
                  ...
                  <SANFormItem
                    ...
                    initialValue={
                      !!user.address ? user.address.district : undefined
                    }
                  >
                    <SANInput
                      data-testid="flix_profile_tab-personal--input-neighborhood"
                      placeholder={t("profile.tab2.neighborhood")}
                      size="large"
                    />
                  </SANFormItem>
                  <SANFormItem
                    ...
                    initialValue={
                      !!user.address ? user.address.complement : undefined
                    }
                  >
                    <SANInput
                      data-testid="flix_profile_tab-personal--input-complement"
                      placeholder={t("profile.tab2.complement.placeholder")}
                      size="large"
                    />
                  </SANFormItem>
                  <SANRow gutter={24}>
                    <SANCol xs={24} sm={12}>
                      <SANFormItem
                        ...
                        mb="md"
                        initialValue={
                          !!user.address ? user.address.city_name : undefined
                        }
                      >
                        <SANInput
                          data-testid="flix_profile_tab-personal--select-state"
                          placeholder={t("profile.tab2.city")}
                          size="large"
                        />
                      </SANFormItem>
                    </SANCol>
                    <SANCol xs={24} sm={12}>
                      <SANFormItem
                        ...
                        label={t("profile.tab2.state.label")}
                        mb="md"
                        initialValue={
                          !!user.address ? user.address.state_id : undefined
                        }
                      >
                        <SANSelect
                          placeholder={t("profile.tab2.state.placeholder")}
                          size="large"
                        >
