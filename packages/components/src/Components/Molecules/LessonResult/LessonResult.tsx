  ...
  const renderCollection = useCallback(
    (question, index) => {
      ...
      const title = `${question.title} ${
        !!question.quiz ? `(${question.corrects}/${question.total})` : ""
      }`;
          ...
          >
            <SANBox display="flex" alignItems="center">
              ...
              <SANBox display="flex" flexDirection="column">
                ...
                <SANTypography fontSize="lg" fontWeight="bold" color="white.5">
                  {title}
                </SANTypography>
              </SANBox>
            </SANBox>
    ...
    <SANBoxStyled borderRadius={{ lg: "base", _: "0px" }}>
      <SANSpin spinning={loading} dark flex>
        <SANBox
          ...
          bg={props.theme}
        >
          <SANTypography fontSize="xxl" fontWeight="bold" color="white.10">
            {props.title}
          </SANTypography>
        </SANBox>
        <SANBox px="xl">
            ...
            <SANCol>
              ...
              >
                ...
                >
                  ...
                  <SANBox as="span" color={props.theme} fontWeight="bold">
                    {` ${props.corrects} ${t("lessonResult.performance.of")} ${
                      props.total
                    } `}
                  </SANBox>
