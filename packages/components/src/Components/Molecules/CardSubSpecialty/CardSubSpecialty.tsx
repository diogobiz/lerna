    ...
    >
      ...
      >
        <SANBox display="flex" alignItems="center">
          {!!image && (
            <SANBox as="img" src={image} width={32} height={32} mr="xs" />
          )}
          <SANTypography
        ...
        <SANBox zIndex={1} width="100%" mt="md">
          <SANBox display="flex" alignItems="center" mb="xs">
            <TitleProgress>{t("cardSubSpecialty.you")}</TitleProgress>
            <SANProgress
              color="primary-3"
          ...
          <SANBox display="flex" alignItems="center">
            <TitleProgress>{t("cardSubSpecialty.others")}</TitleProgress>
            <SANProgress
              color="grey-solid.5"
        ...
        >
          <SANBox
            ...
            justifyContent="center"
          >
            <SANTypography color="white.10" fontSize="lg" fontWeight="bold">
              {continueProp.index}
            </SANTypography>
          </SANBox>
          <SANBox width="calc(100% - 44px)">
            <SANTypography fontSize="xs" color="grey.5" transform="uppercase">
